...
/**
 * Returns a rollup/rolldown plugin that inserts `@__PURE__` annotations after minification so they
 * are not stripped by the minifier.
 */
    ...
    Object.entries(bundle).forEach(([filename, chunk]) => {
      ...
      walk(this.parse(code) as Node, null, {
        ...
        MemberExpression: (node) => {
          annotatedCode.appendLeft(node.start, '/*@__PURE__*/(()=>(').appendLeft(node.end, '))()');
        },
